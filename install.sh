...
if [ "${1:-}" = "--uninstall" ]; then
  ...
  rm -f "$COMMANDS_DIR/refresh-claude-md.md"
  ok "Removed commands"
...
cat > "$COMMANDS_DIR/refresh-claude-md.md" << 'CMDEOF'
---
...
echo "    ~/.claude/commands/refresh-claude-md.md"
echo "  Agents:"
...
echo "  /refresh-claude-md                   # Update ~/.claude/CLAUDE.md"
echo ""
