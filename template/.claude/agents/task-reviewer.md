...
You gather everything else yourself. You have full access to the repo.
...
Run `git diff HEAD~1` to see what the task-builder changed. Then for each changed file:
